...
<nav class='menu'>
	  <ol>
	  	<li class='menu-item'><a href='../Inicio/inicio.php'>Inicio</a></li>
	   	...
	   	<li class='menu-item' style='background-color:#000'><a href='agregarMeseros.php' style='color:#fff'>Meseros</a></li>
				...
				$repetido=1;
					...
					if($repetido==0){
						...
						if($adios==0){
							...
							$reg=mysqli_query($linck,"UPDATE `meseros` SET `nombre` = '$nombre', `usuario` = '$usuario', `contrasena` = '$contrasena' WHERE `id_mesero` = '$adios' AND `id_propietario`='$aidi';");
							echo "<script language='javascript'>"; 
						  ...
						  <form action='editarMeseros.php' method='post' enctype='multipart/form-data'>
						    <div class='row'>
						      ...
						      <div class='input-group input-group-icon'>
									<select style='position:relative; left:3em;' name='adiosvaquero'>
